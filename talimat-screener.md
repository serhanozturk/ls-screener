...
- ZAYIF ETIKETI (v15): ayrisma < PUMP_WEAK_DIV (-15) olan PATLAMA "zayif" isaretlenir
  (Telegram: "zayif (whale katilmiyor)", dashboard badge: uyari isareti). ELENMEZ.
  Backtest kucuk ornekle (29 sinyal) yon gosterdi, birkac hafta daha dogrulanacak.
...
- Deploy sonrasi loglarda "v15 listening" gor = dogrulama
